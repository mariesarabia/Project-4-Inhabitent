 ...
 *
 * Inhabitent Business Hours Boilerplate is an organized, maintainable boilerplate for building widgets using WordPress best practices.
 *
 * Lightly forked from the WordPress Widget Boilerplate by @tommcfarlin.
 *
 * @package   Inhabitent_Business_Hours
 * @author    Marie Sarabia <october.story@gmail.com>
 * @license   GPL-2.0+
...
class Inhabitent_Business_Hours extends WP_Widget {
	...
	public function widget( $args, $instance ) {
		...
		// TODO: Manipulate the widget's values based on their input fields
